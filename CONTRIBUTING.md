...
Fork the [project on Github](https://github.com/CoCreate-app/CoCreate-sandbox) and check out your copy.

```
git sandbox https://github.com/contributor/CoCreate-sandbox.git
cd CoCreate-sandbox
git remote add upstream https://github.com/CoCreate-app/CoCreate-sandbox.git
```
